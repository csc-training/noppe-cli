...
Please navigate to the directory `~/noppe-cli/basics-of-slurm/src/omp/cpp/` where you will find a Hello World program in C++ that implements shared memory parallelism through OpenMP, a Makefile and a run script for the program.
You can also [view the full source](09.1-source.md) rendered here.
