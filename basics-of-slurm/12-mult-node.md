...
Please navigate to the directory `~/noppe-cli/basics-of-slurm/src/mult_nodes/` where you will find a Hello World program in C that implements parallelism with both distributed and shared memory through MPI and OpenMP, a Makefile and a run script for the program.
You can also [view the full source](12.1-source.md) rendered here.
