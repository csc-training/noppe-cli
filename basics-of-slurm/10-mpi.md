...
Please navigate to the directory `~/noppe-cli/basics-of-slurm/src/mpi/cpp/` where you will find a Hello World program in C++ that implements distributed memory parallelism through MPI, a Makefile and a run script for the program.
You can also [view the full source](10.1-source.md) rendered here.
