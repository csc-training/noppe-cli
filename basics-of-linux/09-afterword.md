...
Reflect these below and write a conclusion.
...
However, please do note that the operating state or modified files are not stored either, when the environment is restarted.
...
Now log back in and continue to [the Food for Thought of the Introduction](01.2-food-for-thought.md).
