...
::: note
The `>` redirects the command's output. In this case it redirects it into a file. This is covered in detail in the [Redirections](08-redirections.md#output-redirection) chapter.
:::
